...
def gerar_cardapio(
    ...
    # espaço até a linha 2 calculado pela altura real da tinta de "Almoço"
    # (bbox, não a métrica da fonte, que reserva espaço extra que ficava
    # "solto"), com sobreposição leve de propósito pra ficar bem compacto
    # como no modelo original
    bbox_linha1 = draw.textbbox((center_x - w1 / 2, y), titulo_linha1, font=f_tit_black)
    altura_linha1 = bbox_linha1[3] - bbox_linha1[1]
    y = bbox_linha1[3] - int(altura_linha1 * 0.14)
